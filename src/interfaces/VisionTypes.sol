...
library VisionTypes {
    ...
    /**
     * @notice The typed structured data to be signed by a Vision client
    ...
    struct TransferToRequest {
        uint256 sourceBlockchainId;
        uint256 sourceTransferId; // Vision transfer ID
    ...
    /**
     * @notice The typed structured data to be signed by a Vision
