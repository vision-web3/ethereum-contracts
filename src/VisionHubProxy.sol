 ...
 *
 * @dev Entrypoint for all Vision-Hub-related functions served by multiple
...
contract VisionHubProxy {
    ...
    fallback() external payable {
        ...
        require(facet != address(0), "VisionHub: Function does not exist");
