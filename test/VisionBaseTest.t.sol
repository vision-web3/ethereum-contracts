...
abstract contract VisionBaseTest is Test {
    ...
    uint256 public constant INITIAL_SUPPLY_VSN = 1_000_000_000;
    ...
    function transferRequest()
        public
        view
        returns (VisionTypes.TransferRequest memory)
    {
        return
    ...
    function transferFromRequest()
        public
        view
        returns (VisionTypes.TransferFromRequest memory)
    {
        return
    ...
    function transferToRequest()
        public
        view
        returns (VisionTypes.TransferToRequest memory)
    {
        return
    ...
    function onlyNativeTest(address callee, bytes memory calldata_) public {
        string memory revertMessage = "VisionWrapper: only possible on "
    ...
    function onlyRoleTest(
        ...
        vm.startPrank(address(111));
        bytes memory revertMessage = "VisionRBAC: caller doesn't have role";
        modifierTest(callee, calldata_, revertMessage);
    }
